...
public class EvaluacionProductoEntity implements Serializable {
    @Column(name = "id_evaluacion_producto", nullable = false)
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private long evaluacionProductoId;
    @ManyToOne(targetEntity = ParTipoProductoEntity.class)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.LOCK})
    @JoinColumns(value = {@JoinColumn(name = "id_tipo_producto", referencedColumnName = "id_tipo_producto")}, foreignKey = @ForeignKey(name = "par_tipo_producto_fk"))
